...
@section('title', __('site.user_read'))
                ...
                <div class="card-body">
                    <div class="user-avatar-section">
                        <div class=" d-flex align-items-center flex-column">
                            <img class="img-fluid rounded mb-3 pt-1 mt-4" src="{{ $user->image }}" height="100" width="100" alt="User avatar" />
                            <div class="user-info text-center">
                                <h4 class="mb-2">{{$user->name}}</h4>
                            </div>
                        </div>
                    </div>
                    <div class="d-none d-flex justify-content-around flex-wrap mt-3 pt-3 pb-4 border-bottom">
                    ...
                    <p class="mt-4 small text-uppercase text-muted">{{__('site.Details')}}}</p>
                    <div class="info-container">
                        <ul class="list-unstyled">
                            <li class="mb-2">
                                <span class="fw-semibold me-1">{{__('site.full_name')}}:</span>
                                <span>{{$user->name}}</span>
                            </li>
                            <li class="mb-2 pt-1">
                            ...
                            <li class="mb-2 pt-1">
                                <span class="fw-semibold me-1">{{__('site.Status')}}:</span>
                                <span class="badge bg-label-success">Active</span>
                            </li>
                            <li class="mb-2 pt-1">
                                <span class="fw-semibold me-1">{{__('site.phone')}}:</span>
                                <span>{{$user->phone}}</span>
                            </li>
                            <li class="mb-2 pt-1">
                                <span class="fw-semibold me-1">{{__('site.Languages')}}:</span>
                                <span>{{$user->lang}}</span>
                            </li>
{{--
                            <li class="mb-2 pt-1">
                        ...
                        <div class="d-flex justify-content-center">
                            <a href="javascript:;" class="btn btn-primary me-3" data-bs-target="#editUser" data-bs-toggle="modal">{{__('site.edit')}}</a>
